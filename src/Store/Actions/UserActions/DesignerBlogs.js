...
export const fetchBlogSuccess = (profileblogs) => {
    return {
        type: actionTypes.Fetch_DesignerProfile_Blog_Success,
...
export const fetchBlogFailed = (error) => {
    return {
        type: actionTypes.Fetch_DesignerProfile_Blog_Failed,
        error: error
    };
};
...
export const fetchBlogStart = () => {
    return {
        type: actionTypes.Fetch_DesignerProfile_Blog_Start
    };
};

export const FetchDesignerBlogs = (token, limit) => {
    return dispatch => {
        //Album Fetch

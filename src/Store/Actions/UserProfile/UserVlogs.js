...
export const fetchVlogSuccess = (profilevlogs) => {
    return {
        type: actionTypes.Fetch_UserProfile_Vlog_Success,
...
export const fetchVlogFailed = (error) => {
    return {
        type: actionTypes.Fetch_UserProfile_Vlog_Failed,
        error: error
    };
};
...
export const fetchVlogStart = () => {
    return {
        type: actionTypes.Fetch_UserProfile_Vlog_Start
    };
};

export const FetchUserVlogs = (token, userid, limit) => {
    return dispatch => {
        //Album Fetch
